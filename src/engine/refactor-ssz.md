...
- [Endpoint containers](#endpoint-containers)
  ...
  - [`POST /{fork}/payloads/witness`](#post-forkpayloadswitness)
...
[`POST /{fork}/payloads/witness`](#post-forkpayloadswitness). It carries
...
### `POST /{fork}/payloads/witness`

Optional, Amsterdam+. Same request as
[`POST /{fork}/payloads`](#post-forkpayloads); the response is a
...
Identical to `POST /{fork}/payloads` — `ExecutionPayloadEnvelopeAmsterdam`
